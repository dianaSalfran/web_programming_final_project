...
from .forms import CustomUserForm, ArtistaForm, ObraForm
...
class ObraListView(LoginRequiredMixin, ListView):
    model = Obra
    template_name = 'obra/obra.html'


class ObraCreate(LoginRequiredMixin, CreateView):
    model = Obra
    template_name = 'obra/crear_obra.html'
    form_class = ObraForm
...
class UpdateArtista(LoginRequiredMixin, UpdateView):
    model = Artista
    form_class = ArtistaForm
    template_name = 'artista/artista_form.html'
