...
from . import views
from .views import Home, Artista, Obra, Modality, Eventos, Registrar, ModalityCreate, EventCreate, ArtistCreate, \
    ObraCreate, UpdateArtista, UpdateObra, UpdateModality, UpdateEvento, EliminarArtista, EliminarObra

urlpatterns = [
    path('', Home.as_view(), name='index'),
    path('accounts/logout', auth_views.LogoutView.as_view(template_name='accounts/login'), name='logout'),
    path('artista', Artista.as_view(), name='artista'),
